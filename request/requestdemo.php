       ...
       <div class="nav" style="height:60px;background-color:#164277">
        ...
        <div class="nav-header">
          <div class="nav-title">
            ...
            <h2><a href="" class="logo" style="color: white; font-weight: bold; padding-left: 20px;text-decoration: none;">cure4soul<span class="dot" style="color: #00c3da;">.</span></a></h2>
          </div>
        </div>
        <div class="nav-btn">
          <label for="nav-check">
        ...
        <div class="nav-links">
          <a href="//github.io/jo_geek" target="_blank">How We Work</a>
          <a href="http://stackoverflow.com/users/4084003/" target="_blank">Wellness</a>
          <a href="https://in.linkedin.com/in/jonesvinothjoseph" target="_blank">Resources</a>
          <a href="https://codepen.io/jo_Geek/" target="_blank">Who Are We</a>
          <a href="https://jsfiddle.net/user/jo_Geek/" target="_blank">Support</a>
